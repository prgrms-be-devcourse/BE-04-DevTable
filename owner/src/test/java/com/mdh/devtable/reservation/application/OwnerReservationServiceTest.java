...
import com.mdh.devtable.reservation.write.application.OwnerReservationService;
import com.mdh.devtable.reservation.write.infra.persistence.OwnerReservationRepository;
import com.mdh.devtable.reservation.write.presentation.dto.SeatCreateRequest;
import com.mdh.devtable.reservation.write.presentation.dto.ShopReservationCreateRequest;
...
class OwnerReservationServiceTest {
    ...
    void createShopReservationDateTime() {
        ...
        verify(ownerReservationRepository, times(1)).saveAllShopReservationDateTimeSeat(anyList());
    }
