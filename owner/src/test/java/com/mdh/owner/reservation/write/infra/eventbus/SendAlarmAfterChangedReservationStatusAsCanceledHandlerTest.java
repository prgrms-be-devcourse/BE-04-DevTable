...
class SendAlarmAfterChangedReservationStatusAsCanceledHandlerTest {

    @InjectMocks
    private SendAlarmAfterChangedReservationStatusAsCanceledHandler eventHandler;
    ...
    @DisplayName("점주에 의해 예약이 취소된 이후 취소 알람이 발송된다.")
    @Test
    void sendAlarmAfterReservationCanceled() {
        ...
        var event = new ReservationChangedAsCancelEvent(reservation);
